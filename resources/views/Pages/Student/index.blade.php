                    ...
                    <table class="table align-middle table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="bg-primary bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center me-2"
                                            ...
                                            <span class="text-primary fw-bold small">{{ strtoupper(substr($student->name, 0, 1)) }}</span>
                                        </div>
                                        <div>
                                ...
                                <!-- Class -->
                                <td>
                                    <span class="badge bg-info">{{ $student->classType->name ?? 'No Class' }}</span>
                                </td>

                                <!-- Parent Name -->
                                <td><span class="text-dark small">{{ $student->parent_name ?? 'N/A' }}</span></td>

                                <!-- Phone -->
                                <td><span class="text-muted small">{{ $student->phone ?? 'N/A' }}</span></td>

                                <!-- Address -->
                                <td><span class="text-muted small">{{ \Illuminate\Support\Str::limit($student->address, 30) ?? 'N/A' }}</span></td>
